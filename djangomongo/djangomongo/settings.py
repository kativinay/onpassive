...
SECRET_KEY = 'v*9c^fc+*8x%s9fmz_$g%2p9!k4%a0)+w@923qo@zj1zevnzoh'
...
BASE_URL = os.path.join(BASE_DIR,'static','media')
...
# DEFAULT_FILE_STORAGE = 'mongo.storage.GridFSStorage'
